...
{
	if (jQuery('#inpost_added_machine_field').length > 0)
	{
		// Do nothing.
		return;
	}
	...
	var html = '';
 		...
 		html += '<tr id="inpost_added_machine_field" class="inpostshipping_0">'; 
	       ...
	       html += '<img src="';
	       html += 'https://inpost247.uk/example-stores/images/map_icon.png"  alt="Map of InPost 24/7 Parcel Lockers" title="Map of InPost 24/7 Parcel Lockers" </span></a>';
